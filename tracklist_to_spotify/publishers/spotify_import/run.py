"""
Taken from https://github.com/mewforest/spotify-import/blob/master/spotify_import.py
I would have created a git+https:// dep for this but without pyproject.toml, it wasn't
simple
"""
